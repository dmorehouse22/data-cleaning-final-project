...
1. Rename variables in order to manipulate them into code (including modifying variables with mutate)
2. Selecting only the variables needed for data visualizations
3. Reformat correct oxygen hour & surface area as doubles rather than character variables
